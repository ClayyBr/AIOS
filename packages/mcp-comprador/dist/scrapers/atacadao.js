...
async function buscar(ingrediente) {
    ...
    try {
        ...
        const produtos = await page.evaluate(() => {
            ...
            const productCards = document.querySelectorAll('section[class*="product"], div[class*="product-card"], [class*="ProductCard"], [data-testid*="product"], article');
            ...
            if (items.length === 0) {
                ...
                allLinks.forEach((a) => {
                    ...
                    if (!nome || nome.length < 5 || nome.length > 200)
                        return;
...
export async function closeBrowserAtacadao() {
    if (browserInstance) {
...
const atacadaoScraper = {
    nome: MERCADO,
    buscar,
};
export default atacadaoScraper;
//# sourceMappingURL=atacadao.js.map