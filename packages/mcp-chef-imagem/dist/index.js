...
const VALID_RESOLUTIONS = ["512px", "1K", "2K", "4K"];
// ============================================================================
// Helpers
// ============================================================================
/**
...
// ============================================================================
server.tool("gerar_imagem_prato", "Gera uma imagem fotorrealista de um prato de restaurante usando Google AI Studio (Gemini 3.1 Flash Image). " +
    ...
    prompt: z
        ...
        .describe("Prompt fotográfico descritivo do prato. Quanto mais detalhado, melhor o resultado. " +
    ...
    imagem_referencia: z
        .string()
        .optional()
        .describe("Imagem de referência codificada em base64. Quando fornecida, o modelo tentará manter " +
    ...
    negative_prompt: z
        .string()
        .optional()
        .describe("Restrições negativas — o que NÃO deve aparecer na imagem. " +
        "Exemplo: 'sem mãos humanas, sem talheres de plástico, sem texto, sem watermark'"),
    aspect_ratio: z
        .enum(VALID_ASPECT_RATIOS)
        .optional()
        .default("1:1")
        .describe("Aspecto da imagem gerada. Opções: 1:1 (quadrado, Instagram), 3:4 (retrato), " +
...
}, async ({ prompt, imagem_referencia, mime_type_referencia, negative_prompt, aspect_ratio, resolution, }) => {
    // Validar API Key
            ...
            content: [
                {
                    ...
                    text: JSON.stringify({
                        success: false,
                        error: "API Key não configurada. Configure a variável de ambiente GOOGLE_AI_STUDIO_API_KEY. " +
