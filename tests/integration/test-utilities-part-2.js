...
// Agents to test
const AGENTS_TO_TEST = ['aios-master', 'architect', 'dev', 'qa', 'devops'];
...
try {
  ...
  const validateScriptPath = path.resolve(
    ROOT_PATH,
    '..',
    'outputs',
    'architecture-map',
...
try {
  const detectGapsPath = path.resolve(
    ROOT_PATH,
    '..',
    'outputs',
    'architecture-map',
...
try {
  const synthesizePath = path.resolve(
    ROOT_PATH,
    '..',
    'outputs',
    'architecture-map',
