 ...
 */
export async function buscarViaGoogle(ingrediente, mercado, dominio) {
    const resultados = [];
...
function parsePrecoGoogle(texto) {
    const limpo = texto
        .replace(/R\$\s*/g, "")
        .replace(/\./g, "")
        .replace(",", ".")
