...
const scrapers = [spaniScraper, tendaScraper, atacadaoScraper];
// ============================================================================
// Limpeza de Dados
// ============================================================================
/**
 ...
 */
function ehRelevante(nomeProduto, ingrediente) {
    ...
    return termos.some((termo) => {
        if (termo.length < 3)
            return true; // Ignorar palavras muito curtas
    ...
    for (const scraper of scrapers) {
        ...
        for (const ingrediente of INGREDIENTES) {
            try {
                ...
                todosResultadosBrutos.push(...resultados.map((r) => ({ ...r, ingredienteBuscado: ingrediente })));
            }
            catch (error) {
