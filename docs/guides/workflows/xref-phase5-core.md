...
| --------------------- | ---------------------------------------------------------------------------------------- |
| `tests/core/`         | execution/_ (7 test files), orchestration/_ (6 test files)                               |
...
| `tests/unit/`         | session/context-detector, utils/security-utils, mcp/_, manifest/_, quality-gates/\*      |
| `tests/integration/`  | quality-gates/_, mcp/_, session/context-detector, registry/registry-loader               |
...
_End of Phase 5 Cross-Reference Analysis_
